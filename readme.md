...
- **[command-extensions.md](source/timewarp-amuru/core/command-extensions.md)** - Static API documentation
- **[command-result.md](source/timewarp-amuru/core/command-result.md)** - Fluent interface documentation
